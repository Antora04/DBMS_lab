...
from department;
 ...
 DELIMITER //
 create procedure get_dept_instructors (IN dept varchar(50))
 BEGIN 
 select ID,name
 from instructor
 ...
 END//
 DELIMITER ;
 CALL register_student('76543','CS-101','1','Fall',2024);
...
insert into instructor values('12345','sayma','Biology',180000);
